...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"healthheldtokenaddress\"\n"
            "\nReturn information about the given healthheldtoken address.\n"
            "\nArguments:\n"
            "1. \"healthheldtokenaddress\"     (string, required) The healthheldtoken address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"healthheldtokenaddress\", (string) The healthheldtoken address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are healthheldtoken addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) healthheldtoken address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"healthheldtokenaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"healthheldtokenaddress\"  (string, required) The healthheldtoken address to use for the signature.\n"
