...
std::string HelpMessageCli()
{
    ...
    strUsage += "\n" + _("SSL options: (see the healthheldtoken Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  healthheldtoken-cli [options] <command> [params]  " + _("Send command to healthheldtoken Core") + "\n" +
                  "  healthheldtoken-cli [options] help                " + _("List commands") + "\n" +
                  "  healthheldtoken-cli [options] help <command>      " + _("Get help for a command") + "\n";
