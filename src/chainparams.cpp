...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        (      0, uint256("0x000002517a675a6f3d36c80cc30513fbcc5c9af012b88605026ce91cdbd9697f"))
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1462816785, // * UNIX timestamp of last checkpoint block
        40523,   // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0471cf2137fc9082e87131f29a98c734d85ee119892edc3fbb24b29c1aa3a95bc6454e2b96475aaa26ea38f97c59e628ac3d8b9e2c2b37b97f464cb42f4f0d2b26");
        nDefaultPort = 27150;//p2p port for healthheldtoken
        bnProofOfWorkLimit = ~uint256(0) >> 20;
        nSubsidyHalvingInterval = 21024000;
        nEnforceBlockUpgradeMajority = 750;
        nRejectBlockOutdatedMajority = 950;
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 0;
        nTargetTimespan = 30 * 20; // 10 mins
        nTargetSpacing = 30 * 1; // 0.5 minutes

        const char* pszTimestamp = "blockchain now becomes more and more popular. 2018/5/8";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1525807578;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 2011337;
        ...
        uint256 merkleroot  = uint256("0x27b5da2bb7387d950d78185b34b6a2773755a4dc78f2ed039fedeaa6fb96e5af");
        uint256 genesishash = uint256("0x000002517a675a6f3d36c80cc30513fbcc5c9af012b88605026ce91cdbd9697f");
...
/////////////////////////////////////////////////////////
        ...
        vSeeds.push_back(CDNSSeedData("test", "47.88.57.145"));
        vSeeds.push_back(CDNSSeedData("node1", "118.184.26.135"));
        vSeeds.push_back(CDNSSeedData("node2", "118.184.26.142"));
        vSeeds.push_back(CDNSSeedData("node3", "118.184.26.143"));
        vSeeds.push_back(CDNSSeedData("node4", "118.184.26.144"));
        vSeeds.push_back(CDNSSeedData("node5", "118.184.26.145"));
        vSeeds.push_back(CDNSSeedData("node6", "118.184.26.146"));
        ...
        // healthheldtoken: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("healthheldtokentools.com", "testnet-seed.healthheldtokentools.com"));
        ...
        // healthheldtoken: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // healthheldtoken: v2 enforced using Bitcoin's supermajority rule
