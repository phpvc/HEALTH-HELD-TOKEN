...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("healthheldtoken Core healthheldtoken-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  healthheldtoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded healthheldtoken transaction") + "\n" +
              "  healthheldtoken-tx [options] -create [commands]   " + _("Create hex-encoded healthheldtoken transaction") + "\n" +
              "\n";
